...
const AboutUs: React.FC = () => {
    return (
        <div className={styles.aboutUsContainer}> {/* Apply styles using the imported styles object */}
            <h1>About Us</h1>
            <p>
                Welcome to TinyLivingHacks! Our mission is to empower people to embrace a simpler and more sustainable way of living by providing tips, tricks, and inspiration for tiny homes and eco-friendly living.
            </p>
            <p>
